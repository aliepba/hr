        ...
        <form>
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" nama="nama_jabatan" placeholder="Nama Jabatan">
            </div>
          </div>
          <!-- /.card-body -->
            ...
            <tbody>
              ...
              @foreach ($data as $item => $jabatan)
                  <tr>
                    ...
                    <td>
                      <a href="#" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
